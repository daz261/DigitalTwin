...
def generate_real_value(element):
    #open files of generated data
    #get the data and average it out
    #replace values

    if (element == '820_STDEV_WIC_130'):
        f = open('820_STDEV_WIC_130.csv')
        vals = []
        lines = f.readlines()
        for line in lines:
            #2-column format, append only the val
